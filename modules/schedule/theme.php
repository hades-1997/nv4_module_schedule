 ...
 * @Author ANVH.,JSC <anvh.ceo@gmail.com>
 ...
 * @return
 */
function contact_sendcontact($row_id, $fcat, $ftitle, $checkin, $fname, $femail, $fphone, $fcon, $fpart, $sendinfo = true)
{
	...
	if ($sendinfo) {
		...
		if (!empty($checkin)) {
			...
			$xtpl->parse('main.sendinfo.checkin');
		}
